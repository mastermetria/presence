...
bind = f"0.0.0.0:{os.getenv('APP_PORT', '5000')}"  # Par défaut, utilise 8000 si APP_PORT n'est pas défini
workers = int(os.getenv('GUNICORN_WORKERS', 4))  # Par défaut, 4 workers
